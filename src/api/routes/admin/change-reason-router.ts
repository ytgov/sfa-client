...
export const changeReasonRouter = express.Router();

changeReasonRouter.get("/", async (req: Request, res: Response) => {
...
changeReasonRouter.post("/", body('is_active').isBoolean(), body('description').isString(),
...
changeReasonRouter.patch("/status/:id", [param("id").isInt().notEmpty()], ReturnValidationErrors,
...
changeReasonRouter.patch("/description/:id", [param("id").isInt().notEmpty()], ReturnValidationErrors,
    async (req: Request, res: Response) => {
...
changeReasonRouter.delete("/:id", [param("id").isInt().notEmpty()], ReturnValidationErrors,
    async (req: Request, res: Response) => {
