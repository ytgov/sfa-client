    ...
    try {
      ...
      for (let submittedApp of studentApps) {
        if (
          ...
          if (
            app.csfaAccomodation.accomodations[0].living == "Living at Parents" ||
            app.csfaAccomodation.accomodations[0].living == 1
          )
            prestudyAccomCode = 1;
          else if (
            app.csfaAccomodation.accomodations[0].living == "Living on Own" ||
            app.csfaAccomodation.accomodations[0].living == 2
          )
            prestudyAccomCode = 2;
        ...
        if (
          ...
          if (
            app.csfaAccomodation.accomodations[1].living == "Living at Parents" ||
            app.csfaAccomodation.accomodations[1].living == 1
          )
            studyAccomCode = 1;
          else if (
            app.csfaAccomodation.accomodations[1].living == "Living on Own" ||
            app.csfaAccomodation.accomodations[1].living == 2
          )
            studyAccomCode = 2;
