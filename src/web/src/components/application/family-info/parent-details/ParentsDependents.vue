<template>
  <div>
    ...
    <v-card class="default mb-5" v-for="(dependent, index) in application?.parent_dependents" :key="index">
      <v-card-text>
        <div class="row">
          <div class="col-md-6">
    ...
    <v-card class="default mb-5" v-if="showAdd">
      <v-card-text class="row">
        ...
        <div class="col-md-6 d-flex justify-end">
          <v-btn color="error" x-small fab class="my-0" @click="setClose">
            <v-icon>mdi-close</v-icon>
          </v-btn>
          <v-btn color="success" x-small fab class="my-0 ml-5" @click="addRecord">
        ...
        <div class="col-md-2">
          ...
          >
            ...
            <v-date-picker v-model="newRecord.birth_date" @input="show_menu_insert = false"> </v-date-picker>
          </v-menu>
        </div>
        <div class="col-md-2 d-flex">
          <h3 class="text-subtitle-1 mt-1 mr-2">Age</h3>
        ...
        <div class="col-md-3">
          <v-switch class="my-0" label="Resides with" v-model="newRecord.is_residing"> </v-switch>
        </div>
        <div class="col-md-3">
          <v-switch class="my-0" label="Shared custody" v-model="newRecord.is_shared_custody"> </v-switch>
        </div>
        <div class="col-md-3">
          <v-switch class="my-0" label="In post-secondary" v-model="newRecord.is_attend_post_secondary"> </v-switch>
        </div>
        <div class="col-md-3">
          <v-switch class="my-0" label="Eligible dependent" v-model="newRecord.is_eligible"> </v-switch>
        </div>
