...
<style>
  ...
  .csgdse-assessment .right-block-container > div{
    border-left: 0px;
  }
  .csgdse-assessment .right-block-container{
  ...
  .csgdse-assessment .right-block-container img{
  ...
  @media (max-width: 1263px) {
    ...
    .csgdse-assessment .right-block-container .not-displayed-lg{
