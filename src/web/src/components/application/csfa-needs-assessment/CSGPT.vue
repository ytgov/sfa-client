<template>
  <div class="home csgpt-assessment">
    <div class="col-md-12">
      <v-card class="default mb-5 bg-color-blue">
        <div class="col-lg-12 nopadding d-flex flex-wrap low-margin">
          <v-card-title class="col-xs-12 col-lg-8">Assessment - CSGPT</v-card-title>
        ...
        <v-card-text class="nopadding d-flex flex-wrap">
          <div class="col-xs-12 col-sm-12 col-lg-12 nopadding d-flex flex-wrap">
            ...
            <div class="col-xs-12 col-sm-12 col-lg-5 nopadding">
              <div class="col-lg-12 nopadding d-flex align-center flex-wrap">
                <div class="col-xs-12 col-sm-7 col-lg-10 nopadding d-flex flex-wrap xs-md-low-margin">
          ...
          <div class="col-xs-12 col-md-7 col-lg-7 nopadding left-block-container">
            <div class="col-xs-12 col-lg-12 nopadding d-flex mobile-column-flex low-margin">
              <div class="col-xs-12 col-sm-7 col-md-12 col-lg-4 nopadding d-flex flex-wrap">
                <div class="col-xs-12 col-lg-12">
                  <v-text-field
                      outlined
                      dense
...
<style>
  ...
  .csgpt-assessment .right-block-container > div{
    border-left: 0px;
  }
  .csgpt-assessment .right-block-container{
  ...
  .csgpt-assessment .right-block-container img{
  ...
  @media (max-width: 1263px) {
    ...
    .csgpt-assessment .right-block-container .not-displayed-lg{
