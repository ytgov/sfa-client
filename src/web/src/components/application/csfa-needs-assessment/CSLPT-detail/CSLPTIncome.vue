          ...
          <div class="col-xs-12 col-lg-12 nopadding">
            <div class="col-xs-12 col-lg-12 nopadding d-flex mobile-column-flex">
              <div class="col-xs-12 col-sm-6 col-lg-6 nopadding">
                ...
                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-6 nopadding-bottom">
                  <h3>Student Contribution</h3>
                </div>
                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-6 nopadding-top mobile-low-margin">
                  <v-text-field
                    outlined
                    dense
                    background-color="white"
              ...
              <div class="col-xs-12 col-sm-6 col-lg-6 nopadding">
                ...
                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-6 nopadding-bottom">
                  <h3>Spouse Contribution</h3>
                </div>
                <div class="col-xs-12 col-sm-9 col-md-6 col-lg-6 nopadding-top">
                  <v-text-field
                    outlined
                    dense
                    background-color="white"
