<template>
  <div class="home csgftdep-assessment">
    <div class="col-md-12">
      <v-card class="default mb-5 bg-color-blue">
        <div class="col-lg-12 nopadding d-flex flex-wrap low-margin">
          <v-card-title class="col-xs-12 col-lg-8">Assessment - CSGFTDEP</v-card-title>
...
<style>
  ...
  .csgftdep-assessment .right-block-container > div{
    border-left: 0px;
  }
  .csgftdep-assessment .right-block-container{
  ...
  .csgftdep-assessment .right-block-container img{
  ...
  @media (max-width: 1263px) {
    ...
    .csgftdep-assessment .right-block-container .not-displayed-lg{
