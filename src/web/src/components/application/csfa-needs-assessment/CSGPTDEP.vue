<template>
  <div class="home csgptdep-assessment">
    ...
    <div class="col-md-12">
      <v-card class="default mb-5 bg-color-blue" v-for="item, index in application.funding_requests" :key="index">
        <div class="col-lg-12 nopadding d-flex flex-wrap low-margin">
          <v-card-title class="col-xs-12 col-lg-8">Assessment - CSGPTDEP</v-card-title>
        ...
        <v-card-text class="nopadding d-flex flex-wrap">
          <div class="col-xs-12 col-sm-12 col-lg-12 nopadding d-flex flex-wrap">
            ...
            <div class="col-xs-12 col-sm-12 col-lg-5 nopadding">
              <div class="col-lg-12 nopadding d-flex align-center flex-wrap">
                <div class="col-xs-12 col-sm-6 col-md-7 col-lg-10 nopadding d-flex flex-wrap xs-md-low-margin">
                  ...
                  <div class="col-xs-12 col-lg-11 line-jump-height not-displayed-sx-md"></div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-md-7 col-lg-7 nopadding left-block-container">
            <div class="col-xs-12 col-lg-12 nopadding d-flex mobile-column-flex low-margin">
              <div class="col-xs-12 col-sm-6 col-lg-4 nopadding d-flex flex-wrap">
                <div class="col-xs-12 col-lg-12">
                  <v-text-field
                      outlined
                      dense
              ...
              <div class="col-xs-12 col-lg-4 nopadding">
                <div class="col-xs-12 col-lg-12">
                  <v-text-field
                    ...
                    @keypress="validate.isNumber($event)"
                    v-model="monthly_phase_out_rate"
                  ></v-text-field>
                </div>
                <div class="col-xs-12 col-lg-12">
                  <v-text-field
...
<style>
  ...
  .csgptdep-assessment .right-block-container > div{
    border-left: 0px;
  }
  .csgptdep-assessment .right-block-container{
  ...
  .csgptdep-assessment .right-block-container img{
  ...
  @media (max-width: 1263px) {
    ...
    .csgptdep-assessment .right-block-container .not-displayed-lg{
