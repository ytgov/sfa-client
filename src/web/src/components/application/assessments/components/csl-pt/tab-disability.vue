<template>
  <div v-if="assessment">
    <v-alert type="warning" v-if="!fundingRequest" class="mb-0">
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("csgPartTimeDisabilityStore", ["assessedAmount", "previousDisbursements", "netAmount"]),
  ...
  methods: {
    ...mapActions("csgPartTimeDisabilityStore", ["makeDisbursements"]),
    disburseClick() {
