        ...
        <div class="row">
          ...
          <div class="col-md-4 pt-0">
            <v-switch
              ...
              v-model="pre_study.bus_available"
            ></v-switch>
          </div>
          <div class="col-md-4">
            <v-text-field
              ...
              v-model="pre_study.distance_from_school"
            ></v-text-field>
          </div>
        </div>
      </v-card-text>
