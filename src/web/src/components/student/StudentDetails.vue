...
import EducationHistoryForm from "./EducationHistoryForm.vue";
import BasicDemographicsForm from "./BasicDemographicsForm.vue";
import ConsentForm from "./ConsentForm.vue";
import ContactForm from "./ContactForm.vue";
import StudentDependentsForm from "./StudentDependentsForm.vue";

import SpouseForm from "./SpouseForm.vue";
import CslRestrictionForm from "./CSLRestrictionForm.vue";
import YeaInfoForm from "./YEAInfoForm.vue";
import ResidenceHistoryForm from './ResidenceHistoryForm.vue';

export default {
  name: "Home",
  components: { ContactForm, BasicDemographicsForm, ConsentForm, StudentDependentsForm, EducationHistoryForm, SpouseForm, CslRestrictionForm, YeaInfoForm, ResidenceHistoryForm },
  computed: {
