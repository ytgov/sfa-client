<template>
  <div>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <v-text-field
              ...
              @change="
                doSaveStudent('pre_funding_years_used', student.pre_funding_years_used, 'studentInfo', student.id)
              "
            >
            </v-text-field>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <v-text-field
              ...
              @change="
                doSaveStudent('adj_sta_upgrading_weeks', student.adj_sta_upgrading_weeks, 'studentInfo', student.id)
              "
            >
            </v-text-field>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <v-text-field
              ...
              @change="
                doSaveStudent('adj_outside_travel_cnt', student.adj_outside_travel_cnt, 'studentInfo', student.id)
              "
            >
            </v-text-field>
          </div>
    ...
    <v-card class="default mb-5">
      <v-card-title class="text-h6 font-weight-regular">Identification</v-card-title>
      <v-card-text>
        <div class="row">
          <div class="col-md-3">
            <v-text-field
...
export default {
  data: () => ({
    dialogModel: false,
    columns_names: ["", "Pre-System Data", "Pre-Legislation Chg", "Adjust", "Total Used", ""],
    records: [
      "Funded Since",
      "Funded Years Used",
      "YG STA Funded Weeks",
  ...
  computed: {
    ...
    totalSTAUpWeeks() {
      const total =
        this.student.pre_leg_sta_up_weeks +
        Number(this.student.adj_sta_upgrading_weeks) +
        this.student.post_leg_sta_up_weeks;
      return total || 0;
    },
    totalYGSTAFundWeeks() {
      const total =
