...
export default {
    ...
    methods: {        
        ...
        generatePDF(index) {       
            ...
            const boxesParagraphs = [boxesParagraph1, boxesParagraph2, boxesParagraph3, boxesParagraph4, boxesParagraph5, boxesParagraph6, boxesParagraph7];
            ...
            const lineSrc = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAoMAAAAHCAYAAABz0EdpAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABLSURBVHhe7dmxDQAhDAPA5PffGdALUVPjuyZSJrDsHksBABDp2xcAgECnGezu/wEAwBtuBmAzMQBAMDMxAEAwYRAAIJgwCAAQq2oCxpYPAOUrzPUAAAAASUVORK5CYII=";
            ...
            const vendorArray = [boxesParagraph1, address, city, province, postalCode, country, telephone, email, addressType, vendor, employee, vendorName, paymentType];

            const vendorSpans = [spanAddress, spanCity, spanProvince, spanPostalCode, spanCountry, spanTelephone, spanEmail, spanAddressType, spanVendor, spanEmployee, spanVendorName, spanPaymentType];                                  
