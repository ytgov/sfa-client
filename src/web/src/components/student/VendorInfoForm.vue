...
export default {
    ...
    methods: {        
        ...
        generatePDF(index) {                    
            ...
            /* PARAGRAPHS */ 
            const headerParagraph1 = document.createElement("p");
            headerParagraph1.innerText = "GOVERNMENT OF YUKON, DEPARTMENT OF EDUCATION";
            headerParagraph1.style.fontSize = "3.6px";
            headerParagraph1.style.fontFamily = "Montserrat, Helvetica, Arial, sans-serif";
            headerParagraph1.style.fontWeight = "700";
            headerParagraph1.style.textAlign = "right";        

            const headerParagraph2 = document.createElement("p");
            headerParagraph2.innerText = "STUDENT FINANCIAL ASSISTANCE";  
            headerParagraph2.style.fontSize = "3.6px";
            headerParagraph2.style.fontFamily = "Montserrat, Helvetica, Arial, sans-serif";
            headerParagraph2.style.fontWeight = "700";    
            headerParagraph2.style.textAlign = "right";           
            headerParagraph2.style.marginBottom = "3px";           

            const headerParagraph3 = document.createElement("p");
            headerParagraph3.innerText = "Accounts Payable Vendor Update Request";  
            headerParagraph3.style.fontSize = "4.5px";            
            headerParagraph3.style.fontFamily = "Montserrat, Helvetica, Arial, sans-serif";
            headerParagraph3.style.fontWeight = "700";   
            headerParagraph3.style.textAlign = "right";       
            ...
            const spanUpdateRequestedDate = document.createElement("span");
            const spanUpdateCompletedDate = document.createElement("span");
            const spanStudentId = document.createElement("span");
            ...
            const updateRequestedDate = document.createElement("p");
            const updateCompletedDate = document.createElement("p");
            const studentId = document.createElement("p");     
                                   
            
            const vendorArray = [id, address, city, province, postalCode, country, telephone, email, addressType, vendor, createdDate, updateRequestedDate, updateCompletedDate, studentId];
            const vendorSpans = [ spanId, spanAddress, spanCity, spanProvince, spanPostalCode, spanCountry, spanTelephone, spanEmail, spanAddressType, spanVendor, spanCreatedDate, spanUpdateRequestedDate, spanUpdateCompletedDate, spanStudentId];
            ...
            createdDate.innerText = "Created Date: ";
            updateRequestedDate.innerText = "Requested Date: ";
            updateCompletedDate.innerText = "Completed Date: ";
            ...
            spanId.innerText = this.student.vendor_updates[index].id;
            ...
            spanUpdateRequestedDate.innerText = this.student.vendor_updates[index].update_requested_date;
            spanUpdateCompletedDate.innerText = this.student.vendor_updates[index].update_completed_date;
            spanStudentId.innerText = this.student.vendor_updates[index].student_id;	   
            ...
            for(let i = 0; i < vendorSpans.length; i++) {
                switch (i) {
                    case 0:
                        vendorSpans[i].style.paddingLeft = "50px";                                                
                        break;
                    case 1:
                        vendorSpans[i].style.paddingLeft = "39px";                                                
                        break;
                    case 2:
                    vendorSpans[i].style.paddingLeft = "47px";  
                        break;
                    case 3:
                    vendorSpans[i].style.paddingLeft = "38px";      
                        break;
                    case 4:
                    vendorSpans[i].style.paddingLeft = "32px";  
                        break;
                    case 5:
                    vendorSpans[i].style.paddingLeft = "40px";  
                        break;
                    case 6:
                    vendorSpans[i].style.paddingLeft = "35px";  
                        break;
                    case 7:
                    vendorSpans[i].style.paddingLeft = "44px";  
                        break;
                    case 8:
                    vendorSpans[i].style.paddingLeft = "29px";  
                        break;
                    case 9:
                    vendorSpans[i].style.paddingLeft = "5px";                      
                        break;
                    case 10:
                    vendorSpans[i].style.paddingLeft = "30px";  
                        break;
                    case 11:
                    vendorSpans[i].style.paddingLeft = "50px";  
                        break;
            ...
            // for(let info of vendorSpans) {        
            //     info.style.display = "inline-block";                
            //     info.style.textAlign = "right";                
                
            // }

    //console.log(this.student.vendor_updates);
            //console.log(this.student.vendor_updates);
            ...
            line.src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAoMAAAAHCAYAAABz0EdpAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsMAAA7DAcdvqGQAAABLSURBVHhe7dmxDQAhDAPA5PffGdALUVPjuyZSJrDsHksBABDp2xcAgECnGezu/wEAwBtuBmAzMQBAMDMxAEAwYRAAIJgwCAAQq2oCxpYPAOUrzPUAAAAASUVORK5CYII="
            ...
            footerParagraph1.innerText = "Prepared by: " + this.username + ". Department: " + "Date: " + spanCreatedDate.innerText.slice(0, 10);  
            footerParagraph1.style.fontSize = "4px";  
            footerParagraph1.style.marginTop = "60px";  
            footerParagraph1.style.marginBottom = "10px";  
            footerParagraph1.style.paddingLeft = "15px";  
            footerParagraph1.style.paddingRight = "15px";  
            ...
            footerParagraph2.style.paddingRight = "15px";  
            footerParagraph2.style.marginBottom = "10px";  
            ...
            container.appendChild(updateRequestedDate);
            container.appendChild(updateCompletedDate);
            container.appendChild(studentId);
            container.appendChild(footerParagraph1);
            ...
            createdDate.appendChild(spanCreatedDate);
            updateRequestedDate.appendChild(spanUpdateRequestedDate);
            updateCompletedDate.appendChild(spanUpdateCompletedDate);
            studentId.appendChild(spanStudentId);
