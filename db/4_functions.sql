  ...
  -- GPR VJSFA-263
                  ...
                  , (
                        CASE
                            WHEN app.csl_classification = 2 THEN NULL
                            WHEN app.csl_classification = 5 THEN NULL
                            ELSE sfa.fn_get_csl_dep_age_dis_cnt(app.id, 12, 99, 1/*'Y'*/, app.csl_classification)
                        END
                  ...
                  , (
                        CASE app.csl_classification
                            WHEN 2 THEN NULL
                            WHEN 5 THEN NULL
                            ELSE sfa.fn_get_csl_dep_age_dis_cnt(app.id, 12, 99, 0/*'Y'*/, app.csl_classification)
                        END
