		...
		WHILE @@FETCH_STATUS = 0
			BEGIN   			
				...
				SET @out_record2 = ISNULL(@out_record2, '') + (
					...
					+ ISNULL(RIGHT('000000' + CAST(ABS(@cag_pd_amount) AS VARCHAR(100)), 6), '')
					+ ISNULL(RIGHT('000000' + CAST(ABS(@cag_li_amount) AS VARCHAR(100)), 6), '')
					+ ISNULL(RIGHT('000000' + CAST(ABS(@tg_amount) AS VARCHAR(100)), 6), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@v_total_grant) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgli_nbd_amount) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgmi_nbd_amount) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgpd_nbd_amount) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgdep_nbd_amount) AS VARCHAR(100)), 5), '')
					+ '00000'
					+ ISNULL(LEFT(' ' + '                    ', 20), '')
					+ ISNULL(CAST(@v_mid_point_date AS VARCHAR(100)), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgli_mid_amount) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgmi_mid_amount) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgpd_mid_amount) AS VARCHAR(100)), 5), '')
					+ ISNULL(RIGHT('00000' + CAST(ABS(@csgdep_mid_amount) AS VARCHAR(100)), 5), '')
					+ '00000'
					+ ISNULL(LEFT(' ' + '                    ', 20), '')
